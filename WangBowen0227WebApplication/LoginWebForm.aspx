<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginWebForm.aspx.cs" Inherits="WangBowen0227WebApplication.LoginWebForm" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SimpleDatabseConnectionString %>" DeleteCommand="DELETE FROM [Logon] WHERE [Username] = @Username" InsertCommand="INSERT INTO [Logon] ([Username], [password]) VALUES (@Username, @password)" ProviderName="<%$ ConnectionStrings:SimpleDatabseConnectionString.ProviderName %>" SelectCommand="SELECT [Username], [password] FROM [Logon]" UpdateCommand="UPDATE [Logon] SET [password] = @password WHERE [Username] = @Username">
            <DeleteParameters>
